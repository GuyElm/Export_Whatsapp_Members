function exportToCsv(e, t) {
    ...
    // Add UTF-8 BOM and create Blob with UTF-8 charset
    var o = new Blob(["\uFEFF" + n], { type: "text/csv;charset=utf-8;" }),
        i = document.createElement("a");
    
    void 0 !== i.download && (o = URL.createObjectURL(o),
...
const transactionDoneMap = /* @_PURE_ */ new WeakMap();
const transformCache = /* @_PURE_ */ new WeakMap();
const reverseTransformCache = /* @_PURE_ */ new WeakMap();
...
const cachedMethods = /* @_PURE_ */ new Map();
...
const methodMap = {};
const advanceResults = /* @_PURE_ */ new WeakMap();
const ittrProxiedCursorToOriginalProxy = /* @_PURE_ */ new WeakMap();
    ...
    return __awaiter$1(this, void 0, void 0, function* () {
      if (this.persistent && this.db) {
        ...
        if (existingValue) {
          ...
          const toStore = Object.assign({ "pk": identifier, "_createdAt": /* @PURE_ */ new Date() }, elem);
          if (groupId) {
...
function buildCTABtns() {
  ...
  btnDownload.addEventListener("click", async function() {
    const timestamp = (/* @_PURE_ */ new Date()).toISOString();
